...
public class SmokeTestUserStory01And02 { 
	...
	/**
	 * Evalúa que el Crucero seleccionado muestre el itinerario por día correctamente
	 * @throws IOException
	 * @throws InterruptedException
	 */
	@Test
	...
	/**
	 * Evalúa si cada día despliega la información correcta en cada button "About"
	 * @throws IOException
	 * @throws InterruptedException
	 */
	@Test
	...
	/**
	 * Valida que el botón Book Now se encuentre en el itinerario y realiza movimiento de página hasta el mismo
	 * @throws IOException
	 * @throws InterruptedException
	 */
	@Test
